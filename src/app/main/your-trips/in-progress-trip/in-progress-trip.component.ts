...
@Component({
  selector: 'app-in-progress-trip',
  templateUrl: './in-progress-trip.component.html',
  styleUrls: ['./in-progress-trip.component.scss'],
  animations: [fadeInAnimation],
})
export class InProgressTripComponent implements OnInit {
  ...
  public _getBookings(l: number, p: number): any {
    this._subs.add(
      this._booking
        .getBookingsByGuestId(l, p, 'current_guest', this.searchKey)
        .subscribe({
          next: (res) => {
